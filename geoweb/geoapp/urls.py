...
urlpatterns = patterns('',
    url(r'^$', views.Index),
    url(r'^lumber_load/$', views.LumberLoadListView.as_view(), name='lumber-load-list'),
    ...
    url(r'^lumber_load/(?P<pk>\d+)/detail/$', views.LumberLoadDetailView.as_view(), name='lumber-load-detail'),
